...
const char MMSG_SPEED_VALUE3[8] PROGMEM = { "  75%" };
const char MMSG_SPEED_VALUE4[8] PROGMEM = { "  100%" };
const char MMSG_SPEED_VALUE5[8] PROGMEM = { "  125%" };
const char MMSG_SPEED_VALUE6[8] PROGMEM = { "  150%" };
...
const char MMSG_ERR_PROBING_FAILED[8][56] PROGMEM = {
	"自动调平失败",			// 自动调平失败
	"Probing failed",
	"プロービング失敗",
	"Fallo de sondeo",
...
const char MMSG_ERROR_MAXTEMP[8][68] PROGMEM = {
    ...
    "Düsenfehler: Temperatur übersteigt den zulassigen Höchstwert!",
...
const char MMSG_POXIMITY_LINE[8][250] PROGMEM = {
    ...
    "Nach der Bewegung sollte der Näherungssensor AN sein. Wenn er AUS ist, lockern Sie die Schraube und ändern die Höhe des Sensors bis der Status unten auf AN springt. Danach fixieren Sie die Schraube wieder. Der aktuelle Status ist:",
...
const char MMSG_RESTORE_SETTING_LINE[8][99] PROGMEM = {
    ...
    "\r\n\r\n  Sind Sie sicher, dass Sie den Drucker auf Werkseinstellungen zurücksetzen möchten?",
...
const char MMSG_PRINTING_NOTICE[8][116] PROGMEM = { 
    ...
    "\r\n Diese Funktion ist wahrend eines Druckes nicht möglich. Sie müssen den Druck erst pausieren oder beenden!",
...
const char MMSG_NOZZLE_X_TEXT[8][190] PROGMEM = {
    ...
    "Drucken Sie die Datei NozzleCoarseTune.gcode\r\nWaehlen Sie anschliebend die Nummer des Blocks mit der geringsten horizontalen Abweichung und klicken Sie auf Fortfahren.",
...
const char MMSG_NOZZLE_Y1_TEXT[8][180] PROGMEM = {
    ...
    "Drucken Sie die Datei NozzleFintTune.gcode. Waehlen Sie anschliebend die Nummer des Blocks mit der geringsten horizontalen Abweichung und klicken Sie auf Fortfahren.",
...
const char MMSG_NOZZLE_Y2_TEXT[8][150] PROGMEM = {
    ...
    "Waehlen Sie die Nummer des Blocks mit der geringsten Abweichung zwischen den beiden vertikalen Schichten und klicken Sie auf Speichern.",
...
const char MMSG_NOZZLE_Z_TEXT1[8][320] PROGMEM = {
	...
	"Laden Sie vor der Kalibrierung die Filamente in die Doppeldüsen und reinigen Sie die Düsen. Losen Sie nach dem Abkühlen der Düse das feste Messgerat auf der rechten Seite der Düsen, schieben Sie die Düsen nach oben und verriegeln Sie das Messgerät. Bereiten Sie ein Papier auf dem Bett vor.",
...
const char MMSG_NOZZLE_Z_TEXT2[8][180] PROGMEM = {
    ...
    "Bitte justieren Sie die Höhe der Z-Achse bis der Abstand zwischen Druckbett und Düse nahezu der Papierdicke entspricht.\r\nFür den nachsten Schritt klicken Sie auf Fortfahren.",
...
const char MMSG_NOZZLE_Z_TEXT3[8][290] PROGMEM = {
	...
	"Lösen Sie das feste Maschinenmessgerät auf der rechten Seite der rechten Düse, ziehen Sie das Filament aus dem Extruder, um die Düse auf den Kontakt mit dem Papier zu drücken, und verriegeln Sie dann das Maschinenmessgerät. Klicken Sie auf Weiter, wenn Sie fertig sind.",
...
const char MMSG_NOZZLE_Z_TEXT4[8][290] PROGMEM = {
	...
	"Lösen Sie das feste Maschinenmessgerät auf der rechten Seite der linken Düse, ziehen Sie das Filament aus dem Extruder, um die Düse auf den Kontakt mit dem Papier zu drücken, und verriegeln Sie dann das Maschinenmessgerät. Klicken Sie auf Weiter, wenn Sie fertig sind.",
...
const char MMSG_BABYSTEP_TIP[8][210] = {
	"点击按钮，可以按0.02mm间隔微调喷头高度.\r\n请谨慎使用该功能, 以防损坏模型或打印机.",
	"Click the button to fine-tune the height of the nozzle in 0.02mm intervals. Please use this function carefully to prevent damage to the model or printer.",
	"ボタンをクリックして, ノズルの高さを0.02mm間隔で微調整します. モデルやプリンターの損傷を防ぐため, この機能を慎重に使用してください.",
	"Haga clic en el botón para ajustar la altura de la boquilla en intervalos de 0,02 mm. Utilice esta función con cuidado para evitar da?os en el modelo o la impresora.",
	"Cliquez sur le bouton pour régler avec précision la hauteur de la buse par intervalles de 0,02 mm. Veuillez utiliser cette fonction avec précaution pour éviter d'endommager le modèle ou l'imprimante.",
	"Klicken Sie auf die Schaltfläche, um die Höhe der Düse in Intervallen von 0,02 mm fein einzustellen. Bitte verwenden Sie diese Funktion sorgfältig, um Schäden am Modell oder Drucker zu vermeiden.",
	"Fare clic sul pulsante per regolare con precisione l'altezza dell'ugello a intervalli di 0,02 mm. Utilizzare questa funzione con attenzione per evitare danni al modello o alla stampante.",
	"Klik op de knop om de hoogte van het mondstuk in stappen van 0,02 mm af te stellen. Gebruik deze functie zorgvuldig om schade aan het model of de printer te voorkomen."
};
